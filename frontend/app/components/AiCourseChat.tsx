    ...
    <>
      {open && (
        <>
          ...
          <div className="fixed bottom-24 left-1/2 -translate-x-1/2 w-[85%] h-[55vh] sm:left-auto sm:translate-x-0 sm:right-6 sm:w-[32rem] sm:h-[55vh] z-50 flex flex-col bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden">
